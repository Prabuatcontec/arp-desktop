...
class HomeFrame(tk.Canvas):
    def __init__(self, parent, controller):
        # Home Frame #
        tk.Canvas.__init__(self, parent)
        
        frameButRight = tk.Frame(self, width=1000, height=2,background="#3A7FF6")
        ...
        # Close Button #
        buttonEntryData = tk.Button(frameButRight, text="Close", width=10, height=2, background='#2AA1D3', foreground="#FFFFFF",  command=Close)
...
class ScanFrame(tk.Canvas):
    ...
    def __init__(self, parent, controller):
        ...
        file=getCorrectPath("assets/bar.png"))
        ...
        file=getCorrectPath("assets/Close.png"))
        ...
        file=getCorrectPath("assets/PalletEntry.png"))
        ...
        file=getCorrectPath("assets/palletmax.png"))
        ...
        file=getCorrectPath("assets/Manual.png"))
        ...
        file=getCorrectPath("assets/entry1.png"))
        ...
        file=getCorrectPath("assets/entry2.png"))
        ...
        file=getCorrectPath("assets/login.png"))
        self.loginButtonReal = tk.Button(
        ...
        self.mxtLblCnt.place( x=1067.0,
            y=53.0,
            width=70.0,
            height=35.0)

        self.palletMaxModel = tk.PhotoImage(
        file=getCorrectPath("assets/Model.png"))
        self.palletMaxCntbg = self.create_image(
            1270.0,
            54.0,
        ...
        file=getCorrectPath("assets/Restart.png"))
        ...
        file=getCorrectPath("assets/Customer.png"))
        self.palletMaxCntbg = self.create_image(
            995.0,
            8.0,
        ...
        # self.mxtLblCnt = tk.Label(bd=0,bg='#3A7FF6',fg='#F6A62F', textvariable=self.controller.loginName, text=self.controller.loginName, font=(None, 15))
        # self.mxtLblCnt.place( x=1310.0,
        #     y=82.0,
        #     width=90.0,
        #     height=35.0)
        ...
        file=getCorrectPath("assets/Return.png"))
        ...
        # frameEntryModelFrame = tk.Frame(self, width=100, height=10,background="#3A7FF6")
        # frameEntryModelFrame.grid(row=0, column=2, sticky='nsew', padx=20, pady=1)
        # frameEntryModel = tk.Label(frameEntryModelFrame,background="#3A7FF6", foreground='#C32148', textvariable=self.controller.palletSerialCountTitle, font=(None, 12))
        ...
        # Restart Button #
        # frameButtonOne = tk.Frame(self, width=100, height=10,background="#3A7FF6")
        ...
        # frameEntryData = tk.Frame(self, width=100, height=10,background="#3A7FF6")
        # frameEntryData.grid(row=0, column=4, sticky='nsew', padx=1, pady=1)
        # # Login Name Display #
        # labData = tk.Label(frameEntryData, foreground="#FFFFFF" ,  textvariable=self.controller.loginName, font=(None, 20))
        # labData.grid(row=0, column=0)

        # Logout #
        # frameButRight = tk.Frame(self, width=240, height=10,background="#3A7FF6")
        # frameButRight.grid(row=0, column=6, padx=20, pady=1, sticky='nsew')

        # Manual Scan Button #
        # buttonEntryData = tk.Button(frameButRight, text="Manual", width=10, height=2, background='#2AA1D3', foreground="#FFFFFF",  command=self.loadPopup)
        ...
        # # Close Button #
        # buttonEntryData = tk.Button(frameButRight, text="Close", width=10, height=2, background='#2AA1D3', foreground="#FFFFFF",  command=self.Close)
    ...
    def login(self):
        ...
        if response.status_code != 200:
            ...
            self.mxtLblCnts.place( x=1687.0,
                y=35.0,
                width=100.0,
                height=35.0)
            
            self.logoutButtonw = tk.PhotoImage(
            file=getCorrectPath("assets/Logout.png"))
            self.loginButtonReal = tk.Button(
...
class LoginFrame(tk.Canvas):
    def __init__(self, parent, controller):
        tk.Canvas.__init__(self, parent,relief = "ridge")
        self.controller = controller
        ...
        # self.loginResult = tk.Label(background="#3A7FF6", foreground='#990404', textvariable=self.controller.loginResult)
        # self.loginResult.place(
        #     x=1325.0,
        #     y=90.0,
        # )
        ...
        frameUpLeft = tk.Frame(self, width=1000, height=10,   colormap="new",background="#3A7FF6")
        frameUpLeft.grid(row=0, column=0, sticky='we', padx=1, pady=1)
        frameUpLeftOne = tk.Frame(self, width=200, height=10,   colormap="new",background="#3A7FF6")
        frameUpLeftOne.grid(row=1, column=0, sticky='w', padx=1, pady=1)
        frameButton = tk.Frame(self, width=200, colormap="new",background="#3A7FF6")
        frameButton.grid(row=2, column=0, padx=1, pady=1, sticky='w')

        
        labData = tk.Label(frameButton,background="#3A7FF6", foreground='#2AA1D3')
    ...
    def login(self):
        ...
        if response.status_code != 200:
            self.controller.loginResult.set("Authentication Failed!")
            showerror("Authentication", "Authentication Failed!",
            icon=ERROR)
        else:
            
            self.controller.loginName.set(self.usernamelog.get().upper())
            open(getCorrectPath("static/uploads/_login.txt"), "w").write(f"{self.usernamelog.get() }")
            self.controller.logoutButton.set("Logout")
            self.controller.show_frame(ScanFrame)
            self.usernamelog.place(width=0,height=0)
